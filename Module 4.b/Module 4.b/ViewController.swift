...
//  Module 4.b
//
//  Created by Sarah Pham on 6/10/21.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var totalPaymentAmount: UILabel!
    ...
    @IBAction func calculate(_ sender: Any) {
        ...
        let output = String(format: "Total Payment = $%.2f", payment)
        
        totalPaymentAmount.text = output
